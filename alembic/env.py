...
# Import your DATABASE_URL from app.db
...
# Override the sqlalchemy.url with your DATABASE_URL from app.db
...
def do_run_migrations(connection: Connection) -> None:
    """Helper function that runs migrations with a connection."""
